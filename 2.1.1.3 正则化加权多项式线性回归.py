...
if __name__ == "__main__":
    ...
    model.train(X_train_processed, y_train, regressionType=model.RegressionType.LinearRegression,
    ...
    noweight_model.train(X_train_processed, y_train, regressionType=model.RegressionType.LinearRegression,
