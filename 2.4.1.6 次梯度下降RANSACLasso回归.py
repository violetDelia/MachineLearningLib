...
if __name__ == "__main__":
    ...
    model.RANSAC(X_train, y_train, 5,max_steps=500, regressionType=model.RegressionType.LassoRegression,
                 soulutionType=model.SoulutionType.SGD, processingType=model.ProcessingType.multinomial,
